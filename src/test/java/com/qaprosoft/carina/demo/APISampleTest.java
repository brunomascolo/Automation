...
public class APISampleTest implements IAbstractTest {
    ...
    public void testGetPhotos(){
        ...
        getPhotoMethods.callAPIExpectSuccess();
    ...
    @Test()
    @MethodOwner(owner = "bruno")
    public void testCreatePhotoMissingFields() throws Exception {
        PostPhotoMethod api = new PostPhotoMethod();
        api.setProperties("api/photos/photo.properties");
    ...
    @Test()
    @MethodOwner(owner = "bruno")
    public void testPatchPhoto() throws Exception{
        PostPhotoMethod postPhotoMethod = new PostPhotoMethod();
        postPhotoMethod.setProperties("api/photos/photo.properties");
        postPhotoMethod.callAPIExpectSuccess();
        postPhotoMethod.validateResponse();
        PatchPhotoMethod apiPatch = new PatchPhotoMethod();
        apiPatch.setProperties("api/photos/photo.properties");
